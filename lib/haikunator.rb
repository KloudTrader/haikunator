  ...
  class << self
    ...
    def build(token_range, delimiter)
      ...
      if [true, false].sample
        ...
        sections = [
          qualities[random_seed % qualities.length],
          person[random_seed % person.length],
          token(token_range)
        ]
      end
    ...
    def qualities
      %w(
        ...
        nervous nifty nostalgic objective optimistic peaceful pedantic pensive practical
        priceless quirky quizzical relaxed reverent romantic sad serene sharp silly
        sleepy stoic stupefied suspicious tender thirsty trusting unruffled upbeat
